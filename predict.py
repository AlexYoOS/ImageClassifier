...
ap.add_argument('input_img', default='/home/workspace/ImageClassifier/flowers/test/1/image_06743.jpg', nargs='*', action="store", type = str)
...
model_conv, criterion, optimizer_conv = nn_setup(structure,dropout,hidden_layer1,lr,power)
...
probabilities = utility_functions.predict(path_image, model_conv, number_of_outputs, power)
